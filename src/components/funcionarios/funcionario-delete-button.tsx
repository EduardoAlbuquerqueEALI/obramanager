...
export default function FuncionarioDeleteButton({ id, nome }: { id: string; nome: string }) {
  ...
  return (
    <AlertDialogConfirm
      title={`Remover ${nome}?`}
      description="Todos os treinamentos (certificados) associados também serão apagados."
